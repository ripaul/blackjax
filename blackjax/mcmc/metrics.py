...
def gaussian_euclidean(
    ...
    def scale(
        ...
        *,
        ...
        return _scale(mass_matrix_sqrt, inv_mass_matrix_sqrt, element, inv=inv, trans=trans)
...
def _sq_scale(
    ...
    *,
    ...
    element = _scale(mass_matrix_sqrt, inv_mass_matrix_sqrt, element, inv=inv, trans=not trans)
    element = _scale(mass_matrix_sqrt, inv_mass_matrix_sqrt, element, inv=inv, trans=trans)
    return element
