...
The Elliptical Hit-and-Run algorithm is a constraint-aware sampling algorithm
that combines elliptical directions with hit-and-run sampling. It generates
proposals by sampling directions from an elliptical distribution and then
performing hit-and-run within the constraints.

References
----------
.. [1] "Elliptical Slice Sampling" - Murray et al.
.. [2] "Hit-and-Run algorithms for sampling from convex bodies"
"""
import operator
